...
set_property PACKAGE_PIN AB5 [get_ports prog_empty]
set_property PACKAGE_PIN AE4 [get_ports prog_full]
set_property IOSTANDARD LVCMOS18 [get_ports prog_empty]
set_property IOSTANDARD LVCMOS18 [get_ports prog_full]
